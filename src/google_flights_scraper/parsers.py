...
def extract_airline(flight_description):
    """Extract airline from flight description.

    Args:
        flight_description: Flight description text
...
def extract_departure_info(flight_description):
...
def extract_arrival_info(flight_description):
...
def extract_num_stops(flight_description):
...
def extract_layover_info(flight_description):
...
def extract_duration(flight_description):
...
def extract_baggage_info(flight_description):
...
def extract_price(flight_description):
...
def extract_flight_details(flight_element):
    ...
    Args:
        flight_element: Selenium WebElement containing flight info
    ...
    flight_info["connection_airports"], flight_info["layover_durations"] = \
        extract_layover_info(flight_description)

    flight_info["duration_minutes"], flight_info["duration_str"] = \
        extract_duration(flight_description)

    flight_info["carry_on_bags"], flight_info["checked_bags"] = \
        extract_baggage_info(flight_description)
...
def extract_price_classification(text):
    """Extract price classification from text.

    Args:
        text: Text containing price relativity information
...
def extract_price_difference(text):
...
def extract_price_relativity(wait, driver, timeout):
